...
contextBridge.exposeInMainWorld('agentBrain', Object.freeze({
  ...
  inspectFolder: (cwd) => ipcRenderer.invoke('brain:inspect-folder', cwd),
  toggleSkill: (payload) => ipcRenderer.invoke('brain:toggle-skill', payload),
  toggleRule: (payload) => ipcRenderer.invoke('brain:toggle-rule', payload),
